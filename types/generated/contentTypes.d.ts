...
export interface ApiLivestreamLivestream extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    platform: Schema.Attribute.Enumeration<
      ['YouTube', 'Twitch', 'Vimeo', 'Other']
    >;
    publishedAt: Schema.Attribute.DateTime;
    related_tournament: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiMagazineIssueMagazineIssue
  ...
  info: {
    description: 'MagazineIssue content type';
...
export interface ApiMediaGalleryMediaGallery
  ...
  info: {
    description: 'MediaGallery content type';
  ...
  attributes: {
    ...
    description: Schema.Attribute.Text;
    items: Schema.Attribute.Component<'media.media-item', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiNewsArticleNewsArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<
      ['Registration', 'Rule', 'Tournament', 'Magazine', 'Event']
    >;
...
export interface ApiRuleDocumentRuleDocument
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::rule-document.rule-document'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    season: Schema.Attribute.Relation<'manyToOne', 'api::season.season'>;
...
export interface ApiSeasonSeason extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Season content type';
    displayName: 'Season';
    pluralName: 'seasons';
    singularName: 'season';
  };
...
export interface ApiSponsorSponsor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Sponsor content type';
    displayName: 'Sponsor';
    pluralName: 'sponsors';
...
export interface ApiTeamRegistrationFormTeamRegistrationForm
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    download_file: Schema.Attribute.Media;
    external_link: Schema.Attribute.String;
    is_active: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::team-registration-form.team-registration-form'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    season: Schema.Attribute.Relation<'manyToOne', 'api::season.season'>;
...
export interface ApiTournamentTournament extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    result_file: Schema.Attribute.Media;
...
export interface ApiYouthLeagueApplicationYouthLeagueApplication
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    age_groups: Schema.Attribute.Component<'application.age-group-range', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    form_file: Schema.Attribute.Media;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::youth-league-application.youth-league-application'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    region: Schema.Attribute.Enumeration<
      ['Nord', 'S\u00FCd', 'Steiermarkweit']
    >;
    season: Schema.Attribute.Relation<'manyToOne', 'api::season.season'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::team-registration-form.team-registration-form': ApiTeamRegistrationFormTeamRegistrationForm;
      'api::tournament.tournament': ApiTournamentTournament;
      'api::youth-league-application.youth-league-application': ApiYouthLeagueApplicationYouthLeagueApplication;
